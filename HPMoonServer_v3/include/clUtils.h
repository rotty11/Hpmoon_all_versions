...
typedef struct CLDevice {
	...
	/**
	 * @brief OpenCL object which contains the instances choosen as initial centroids
	 */
	cl_mem objSelInstances;


	/**
	 * @brief OpenCL object which contains the current population
	 */
	cl_mem objPopulation;
