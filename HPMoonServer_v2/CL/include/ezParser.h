...
class ezParserIDGenerator {
public:
  static ezParserIDGenerator& instance () { static ezParserIDGenerator Generator; return Generator; }
  short next () { return ++_id; }
private:
  ezParserIDGenerator() : _id(-1) {}
  short _id;
};
/* ################################################################### */
...
ezOptionValidator::ezOptionValidator(char _type) : s1(0), op(0), quiet(0), type(_type), size(0), insensitive(0) {
  id = ezParserIDGenerator::instance().next();
};
/* ------------------------------------------------------------------- */
...
/* ################################################################### */
void ezParser::add(const char * defaults, bool required, int expectArgs, char delim, const char * help, const char * flag1, ezOptionValidator* validator) {
...
/* ################################################################### */
void ezParser::add(const char * defaults, bool required, int expectArgs, char delim, const char * help, const char * flag1, const char * flag2, ezOptionValidator* validator) {
  int id = this->groups.size();
  OptionGroup * g = new OptionGroup;
  g->defaults = defaults;
  g->isRequired = required;
...
/* ################################################################### */
void ezParser::add(const char * defaults, bool required, int expectArgs, char delim, const char * help, const char * flag1, const char * flag2, const char * flag3, ezOptionValidator* validator) {
  int id = this->groups.size();
  OptionGroup * g = new OptionGroup;
  g->defaults = defaults;
  g->isRequired = required;
...
/* ################################################################### */
void ezParser::add(const char * defaults, bool required, int expectArgs, char delim, const char * help, const char * flag1, const char * flag2, const char * flag3, const char * flag4, ezOptionValidator* validator) {
  int id = this->groups.size();
  OptionGroup * g = new OptionGroup;
  g->defaults = defaults;
  g->isRequired = required;
...
/* ################################################################### */
bool ezParser::exportFile(const char * filename, bool all) {
  int i;
  std::string out;
  bool quote;
...
bool ezParser::importFile(const char * filename, char comment) {
...
/* ################################################################### */
int ezParser::isSet(const char * name) {
...
/* ################################################################### */
int ezParser::isSet(std::string & name) {
...
/* ################################################################### */
OptionGroup * ezParser::get(const char * name) {
...
/* ################################################################### */
void ezParser::getUsage(std::string & usage, int width, Layout layout) {
...
void ezParser::getUsageDescriptions(std::string & usage, int width, Layout layout) {
...
/* ################################################################### */
bool ezParser::gotExpected(std::vector<std::string> & badOptions) {
  int i,j;
...
/* ################################################################### */
bool ezParser::gotRequired(std::vector<std::string> & badOptions) {
  int i;
...
/* ################################################################### */
bool ezParser::gotValid(std::vector<std::string> & badOptions, std::vector<std::string> & badArgs) {
...
/* ################################################################### */
void ezParser::parse(int argc, const char * argv[]) {
  if (argc < 1) return;
...
/* ################################################################### */
void ezParser::prettyPrint(std::string & out) {
  char tmp[256];
  int i,j,k;
